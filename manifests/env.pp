...
class cspace_user::env (
  $heira_configured_ant_opts              = lookup('collectionspace::ant_opts'),
  $heira_configured_catalina_home         = lookup('collectionspace::catalina_home'),
  $heira_configured_catalina_opts         = lookup('collectionspace::catalina_opts'),
  $heira_configured_catalina_pid          = lookup('collectionspace::catalina_pid'),
  $heira_configured_cspace_instance_id    = lookup('collectionspace::cspace_instance_id'),
  $heira_configured_cspace_jeeserver_home = lookup('collectionspace::cspace_jeeserver_home'),
  $heira_configured_jee_port              = lookup('collectionspace::jee_port'),
  $heira_configured_db_admin_user         = lookup('collectionspace::db_admin_user'),
  ...
  $heira_configured_db_admin_password     = lookup('collectionspace::db_admin_password', Data, 'first', generate_password()),
  $heira_configured_db_csadmin_user       = lookup('collectionspace::db_csadmin_user'),
  $heira_configured_db_csadmin_password   = lookup('collectionspace::db_csadmin_password', Data, 'first', generate_password()),
  $heira_configured_db_cspace_password    = lookup('collectionspace::db_cspace_password', Data, 'first', generate_password()),
  $heira_configured_db_host               = lookup('collectionspace::db_host'),
  $heira_configured_db_nuxeo_password     = lookup('collectionspace::db_nuxeo_password', Data, 'first', generate_password()),
  $heira_configured_db_port               = lookup('collectionspace::db_port'),
  $heira_configured_cspace_core_create_disabled_opt = lookup('collectionspace::cspace_core_create_disabled_opt'),
  $heira_configured_db_reader_password    = lookup('collectionspace::db_reader_password', Data, 'first', generate_password()),
  $heira_configured_lc_all                = lookup('collectionspace::lc_all'),
  $heira_configured_maven_opts            = lookup('collectionspace::maven_opts'),
  )
